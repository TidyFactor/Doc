...
3. **Write `README.md`** at the project root: project name/one-line description, install/setup steps (from the runtime & environment findings), usage example, required env vars, and a link to `docs/` for the full reference. Keep it scannable — this is an entry point, not the full documentation.
...
- [ ] Links to `docs/` are present and correct
